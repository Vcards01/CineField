...
namespace ProjetoCinema.BD
{
    class Tables
    {
        ...
        public void CreateSessao()
        {
            ...
            sql.AppendLine("[QIngresso] INTEGER);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(1,1,'12:00',20,1000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(2,1,'15:00',20,1000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(3,3,'12:00',40,1500,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(4,4,'22:00',50,1000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(5,5,'15:00',60,2000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(6,2,'21:00',30,1500,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(7,5,'12:00',60,2000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(1,2,'12:00',30,1000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(2,4,'12:00',50,1000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(4,1,'21:00',20,1000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(4,3,'20:00',40,1500,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(4,2,'18:00',30,1000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(5,5,'16:00',60,2000,0);");
            sql.AppendLine("Insert into Sessao(Filme,Sala,Horario,Lugares,Pentrada,QIngresso)VALUES(7,2,'17:00',30,1000,0);");
            SQLiteCommand cmd = new SQLiteCommand(sql.ToString());
            bd.ExecuteNonQuery(cmd);
        }
